...
def main() -> int:
    ...
    # Ensure corrected values for known constrained fields
    values["/Файл/Документ/СвАктСдПр/ИспрАктСдПр/@НомИспр"] = "1"
    value_sources["/Файл/Документ/СвАктСдПр/ИспрАктСдПр/@НомИспр"] = "manual"
    values["/Файл/Документ/СвАктСдПр/ИспрАктСдПр/@ДатаИспр"] = seed["doc_date"]
    value_sources["/Файл/Документ/СвАктСдПр/ИспрАктСдПр/@ДатаИспр"] = "excel"
