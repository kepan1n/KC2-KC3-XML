...
def main():
    ...
    require_contains(app_js, 'const documentContext = model.documentContext || model.common || {};', 'variants/modern-light/app.js')
    require_contains(app_js, 'const manualSettlementRows = model.xmlExtras?.settlementRows || model.xml?.settlement?.manualRows || [];', 'variants/modern-light/app.js')
    require_contains(app_js, 'const manual = model.xmlP?.manual || model.xml?.manual || {};', 'variants/modern-light/app.js')
    require_contains(app_js, 'const generated = model.xmlP?.generated || model.xml?.generated || {};', 'variants/modern-light/app.js')
    require_contains(app_js, 'const traceableGoods = model.xmlP?.traceableGoods || model.xmlExtras?.traceableGoods || model.xml?.traceableGoods || [];', 'variants/modern-light/app.js')
    ...
    require_absent(app_js, 'const manualSettlementRows = model.xml.settlement?.manualRows || [];', 'variants/modern-light/app.js')
