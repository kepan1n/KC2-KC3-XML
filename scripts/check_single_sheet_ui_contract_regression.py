...
def main():
    ...
    require_contains(app_js, 'Семантическая mini-легенда теперь видна и прямо в реквизитах', 'variants/modern-light/app.js')
    require_contains(app_js, 'data-action="set-field-status-filter"', 'variants/modern-light/app.js')
    require_contains(app_js, 'Только UI-only', 'variants/modern-light/app.js')
    require_contains(app_js, 'data-action="toggle-export-prep-mode"', 'variants/modern-light/app.js')
    require_contains(app_js, 'Подготовка к выгрузке: вкл', 'variants/modern-light/app.js')
    require_contains(app_js, 'ЭП файла подрядчика для Z', 'variants/modern-light/app.js')
    require_contains(app_js, 'ИдИнфПодр/ЭП', 'variants/modern-light/app.js')
    require_contains(app_js, 'СодФХЖ4/СвПрием/@КодСодОпер', 'variants/modern-light/app.js')
    require_contains(app_js, 'СодФХЖ4/ИзвОРасч/@ИзвПоРасч', 'variants/modern-light/app.js')
    require_absent(app_js, 'Файл Z → Приемка/КодПрин', 'variants/modern-light/app.js')
    require_absent(app_js, 'Файл Z → СвУведРасч/ТекстУвед', 'variants/modern-light/app.js')
    require_contains(app_js, 'data-action="toggle-ks2-preview-compare"', 'variants/modern-light/app.js')
    require_contains(app_js, 'Compare mode P/Z', 'variants/modern-light/app.js')
    require_contains(app_js, 'Derived differences', 'variants/modern-light/app.js')
    require_contains(app_js, 'renderXmlPreviewCompareMode', 'variants/modern-light/app.js')
    require_contains(app_js, 'Compare mode показывает P и Z side-by-side', 'variants/modern-light/app.js')
    require_contains(app_js, 'Активные блокеры', 'variants/modern-light/app.js')
    require_contains(app_js, 'Strict блокеры', 'variants/modern-light/app.js')
    require_contains(app_js, 'strict→blocking', 'variants/modern-light/app.js')
    require_contains(app_js, "blockingMode ? 'blocking' : 'advisory'", 'variants/modern-light/app.js')
